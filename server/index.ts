...
import adminCoupons from '../api/admin-coupons';
import adminDelivery from '../api/admin-delivery';
import adminFinance from '../api/admin-finance';
...
import stripeOrderCancel from '../api/stripe-order-cancel';
...
import kitchenMenu from '../api/kitchen-menu';
import storeStatus from '../api/store-status';
...
mount('/api/menu', menu);
mount('/api/store-status', storeStatus);
...
mount('/api/stripe-order-cancel', stripeOrderCancel);
...
mount('/api/kitchen/menu', kitchenMenu);
