...
export const MENU_TRANSLATIONS: Record<number, MenuTranslations> = {
  ...
  7: {
    en: {
      name: 'Thai Milk Tea',
      enName: '',
      description: 'Classic Thai tea aroma with a rich, smooth sweetness.',
      detail: 'Classic Thai black tea with condensed milk. Bold tea aroma and rich texture, with sweetness and ice level options.',
      category: 'Drinks',
      tags: ['Iced drink'],
      optionGroups: [
        { id: 'sweetness', name: 'Sweetness', options: [{ id: 'less', name: 'Less sweet' }, { id: 'regular', name: 'Regular sweet' }] },
        { id: 'ice', name: 'Ice level', options: [{ id: 'less', name: 'Less ice' }, { id: 'regular', name: 'Regular ice' }] },
      ],
    },
    th: {
      name: 'ชาไทยนม',
      enName: '',
      description: 'กลิ่นชาไทยคลาสสิก หวานมันกลมกล่อม',
      detail: 'ชาแดงไทยคลาสสิกผสมนมข้น กลิ่นชาชัด รสเข้มข้น สามารถเลือกระดับความหวานและน้ำแข็งได้',
      category: 'เครื่องดื่ม',
      tags: ['เครื่องดื่มเย็น'],
      optionGroups: [
        { id: 'sweetness', name: 'ระดับความหวาน', options: [{ id: 'less', name: 'หวานน้อย' }, { id: 'regular', name: 'หวานปกติ' }] },
        { id: 'ice', name: 'ระดับน้ำแข็ง', options: [{ id: 'less', name: 'น้ำแข็งน้อย' }, { id: 'regular', name: 'น้ำแข็งปกติ' }] },
      ],
    },
    vi: {
      name: 'Trà sữa Thái',
      enName: '',
      description: 'Hương trà Thái cổ điển, ngọt béo và mượt.',
      detail: 'Trà đỏ Thái cổ điển pha cùng sữa đặc, hương trà rõ và vị đậm. Có thể chọn độ ngọt và lượng đá.',
      category: 'Đồ uống',
      tags: ['Đồ uống đá'],
      optionGroups: [
        { id: 'sweetness', name: 'Độ ngọt', options: [{ id: 'less', name: 'Ít ngọt' }, { id: 'regular', name: 'Ngọt thường' }] },
        { id: 'ice', name: 'Lượng đá', options: [{ id: 'less', name: 'Ít đá' }, { id: 'regular', name: 'Đá thường' }] },
      ],
    },
  },
  8: {
